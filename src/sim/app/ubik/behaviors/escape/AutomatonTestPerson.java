...
/**
 * Example of main automaton (with the behaviour of a TestPerson). It never ends, so a default behaviour is given for cases when the pending transition list is empty
